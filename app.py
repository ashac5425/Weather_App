...
# ==== Decode base64 credentials and set GOOGLE_APPLICATION_CREDENTIALS ====

# Decode and store Speech-to-Text credentials
speech_to_text_b64 = os.getenv("SPEECHTOTEXT_KEY_B64")
if speech_to_text_b64:
    speech_to_text_json_path = "/tmp/speech-to-text.json"
    with open(speech_to_text_json_path, "wb") as f:
        f.write(base64.b64decode(speech_to_text_b64))
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = speech_to_text_json_path

# Decode and store Text-to-Speech credentials (optional)
text_to_speech_b64 = os.getenv("TEXTTOSPEECH_KEY_B64")
if text_to_speech_b64:
    text_to_speech_json_path = "/tmp/text-to-speech.json"
    with open(text_to_speech_json_path, "wb") as f:
        f.write(base64.b64decode(text_to_speech_b64))
    # If your TTS client needs its own credentials path:
    # os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = text_to_speech_json_path
