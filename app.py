...
#     city_name = convert_speech_to_text(audio_file)
#     if not city_name:
...
# Replace with your actual path to the service account key
# os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "speech-service-account.json"
